...
<head>
    ...
    .letra:first-letter {
        ...
        font-size: 300%;
        /* Hacemos crecer la primera letra */
        margin: 10px;
        /* Y le ponemos un margen cuadrado de 5 píxeles */
    }
    </style>
...
-->
        ...
        <div>
            <div class="caption animated zoomInDown">
                <span class="border">Lectura de TXT con ajax</span><br>

                <div id="contenido">
                    <div id="contenedor">
                        <div id="contenido">
                            <div class="letra" id="resultado2"></div>
                            <p><img src="fondo-quijote.png" width="580" height="775"></p>
                            <button type="button" onclick="iniciar()">Cargar Texto (AJAX) >></button>
                            <p>*Texto obtenido de <a href="http://www.quijotipsum.com/"
                                    target="_blank">http://www.quijotipsum.co m/</a></p>
                        </div>
        ...
        <footer>Fuente: <a href="https://javascript.solired.es/051-AJAX/2-quijote.html" class="enlacepie">Dirección URL
                de la web donde esté el Script</a></footer>
    </main>
    <script>
    function myFunction() {
